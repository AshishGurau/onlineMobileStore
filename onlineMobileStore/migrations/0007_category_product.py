# Generated by Django 3.2.5 on 2022-04-02 11:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('onlineMobileStore', '0006_customer_order_orderitem_shippingaddress'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta_description', models.TextField(max_length=500)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='onlineMobileStore.category')),
            ],
        ),
    ]
